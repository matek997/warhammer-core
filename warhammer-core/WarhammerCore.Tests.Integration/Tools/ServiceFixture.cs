...
namespace WarhammerCore.Tests.Integration.Tools
{
    ...
    {
        public WarhammerDbContext DbContext;
        ...
        {
            WarhammerDbContext db = serviceProvider.GetService<WarhammerDbContext>();
            db.Database.EnsureCreated();
            DbContext = db;

            var professionDatabaseSetup = new ProfessionDatabaseSetUp(DbContext);
            professionDatabaseSetup.PrepareDatabase();
        }
    }
